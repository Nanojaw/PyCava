...
jintArray Java_pycava_bridge_Log (JNIEnv* env, jobject obj, jcharArray v0, jshort v1, jintArray v2, jlong v3, jfloat v4, jdouble v5, jchar v6, jboolean v7, jstring v8)
{
    ...
    auto result = pycava::bridge::Log(std::vector(r0, r0 + (*env)->GetArrayLength(env, v0)), (short) v1, std::vector(r2, r2 + (*env)->GetArrayLength(env, v2)), (long long) v3, (float) v4, (double) v5, (wchar_t) v6, (bool) v7, std::wstring(r8), (std::wstring) v8);
